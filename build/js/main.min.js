      ...
      if (o.originalEvent && (o = o.originalEvent), i.isTouched) {
        if (!i.isTouchEvent || "touchmove" === o.type) {
          ...
          if (i.allowTouchCallbacks && a.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
            ...
            if (!(a.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(v, 2)) < a.params.threshold)) if (void 0 === i.isScrolling && (a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : h * h + v * v >= 25 && (c = 180 * Math.atan2(Math.abs(v), Math.abs(h)) / Math.PI, i.isScrolling = a.isHorizontal() ? c > s.touchAngle : 90 - c > s.touchAngle)), i.isScrolling && a.emit("touchMoveOpposite", o), void 0 === i.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1;else if (i.startMoving) {
...
!function (e, t) {
  ...
  return function (e) {
    ...
    function z(e, t) {
      ...
      e.props.sources, o[t] = document.createElement("div"), o[t].className = "".concat(r, "invalid-file-wrapper ").concat(c), o[t].innerHTML = "Invalid source", i[t].classList.add(g), i[t].appendChild(o[t]), s[t].removeChild(s[t].firstChild);
    }
    ...
    function R(e) {
      ...
      o.className = "".concat(r, "nav"), n.appendChild(o), function (e, t) {
        var n = document.createElement("div");
    ...
    function K(e) {
      ...
      n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function (e, t) {
        ...
        a.changeTo = function (e) {
          p.current = e, l.updateStageIndexes(), r.setSlideNumber(e + 1), c.displaySourcesWhichShouldBeDisplayed();
        }, a.jumpTo = function (e) {
          var t = p.current;
        ...
        r.runActions = function () {
          ...
          for (var e = 0; e < a.sources.length; e++) {
            B(s[e], u), e !== c.current && n[e].negative(), o[e] && o[e].adjustSize();
          }
        };
      }(e);
    }
    ...
    function Q(e) {
      ...
      }(e), K(e), o.container = document.createElement("div"), o.container.className = "".concat(r, "container ").concat(a, " ").concat(g), function (e) {
        var t = e.elements;
    ...
    function Z(e) {
      ...
      i.open = function () {
        ...
        h.current = o, p.isInitialized ? r.dispatch("onShow") : Q(e), u.updateStageIndexes(), c.displaySourcesWhichShouldBeDisplayed(), n.setSlideNumber(o + 1), document.body.appendChild(f.container), document.documentElement.classList.add(l), a.addRecompense(), s.attachListeners(), d.runActions(), t[h.current].zero(), r.dispatch("onOpen");
      };
    }
...
var menuBtn = document.querySelectorAll(".js-menu__btn"),
    menu = document.querySelector(".nav"),
    menuClose = document.querySelector(".menu-close");
menuBtn.forEach(function (e) {
  e.addEventListener("click", function () {
    menu.classList.add("nav--visible"), document.body.classList.add("body--fixed");
  });
}), menuClose.addEventListener("click", function () {
  menu.classList.remove("nav--visible"), document.body.classList.remove("body--fixed");
});
var objectSlider = new Swiper(".object__slider", {
  speed: 500,
  loop: !0,
  effect: "fade",
  slidesPerView: 1,
